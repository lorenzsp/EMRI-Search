...
if __name__ == "__main__":
    ...
    gw_data_path = './gw_catalog_masses.csv'
    ...
    not_det_mask = np.array([np.max((r['losses'] - mean_noise)/std_noise) < detection_threshold for r in results_detection])
    print(f"Check sum", np.sum(det_mask) + np.sum(not_det_mask), len(results_detection))
